...
public class PollableServiceConfig implements PollConfig, ScheduleInterval {
    ...
    public PollableServiceConfig(PollableService svc, PollerConfig pollerConfig, PollOutagesConfig pollOutagesConfig, Package pkg, Timer timer, PersisterFactory persisterFactory,
            ThresholdingFactory thresholdingFactory, ResourceStorageDao resourceStorageDao, LocationAwarePollerClient locationAwarePollerClient, IfLabel ifLabelDao) {
        m_service = svc;
        ...
        m_latencyStoringServiceMonitorAdaptor = new LatencyStoringServiceMonitorAdaptor(pollerConfig, pkg, persisterFactory, thresholdingFactory, resourceStorageDao, ifLabelDao);
