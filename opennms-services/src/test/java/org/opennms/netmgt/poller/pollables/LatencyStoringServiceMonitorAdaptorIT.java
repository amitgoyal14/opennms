...
public class LatencyStoringServiceMonitorAdaptorIT implements TemporaryDatabaseAware<MockDatabase> {
    ...
    private void executeThresholdTest(Double[] rtValues) throws Exception {
        ...
        m_mocks.replayAll();
        LatencyStoringServiceMonitorAdaptor adaptor = new LatencyStoringServiceMonitorAdaptor(m_pollerConfig, pkg, m_persisterFactory, m_thresholdingFactory, m_resourceStorageDao,
                                                                                              m_ifLabelDao);
